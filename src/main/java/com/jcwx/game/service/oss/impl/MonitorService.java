...
//
//import com.jcwx.game.common.BytesUtils;
...
//                 String caption = BytesUtils.substring(line, capidx, cmdidx - 1)    
//                         .trim();    
...
//                    		 BytesUtils.substring(line, kmtidx, rocidx - 1).trim())    
//                             .longValue();    
//                     idletime += Long.valueOf(    
//                    		 BytesUtils.substring(line, umtidx, wocidx - 1).trim())    
//                             .longValue();    
//                     continue;    
//                 }    
//   
