 ...
 */
public class RadioItemNameTag extends TagSupport implements Serializable {
    /**
     * 
     */
    ...
    protected void addRadio(StringBuffer sb, String label, String value,
	    boolean matched) {
	...
	for (OssDictData dictData : list) {
	    ...
	    addRadio(sb, stringLabel, stringValue, matched);
	}
	// sb.append("</select>");
