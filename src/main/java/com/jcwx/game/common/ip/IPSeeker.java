...
public class IPSeeker {
	...
	public static Logger logger = Logger.getLogger(IPSeeker.class);
	private Lock lock = new ReentrantLock();
	
	private static final String IP_FILE = IPSeeker.class.getClassLoader().getResource("config/ip/qqwry.dat").toString().substring(5);
	...
	private IPSeeker() {
		...
		logger.info("load IP file success!"); 
	}
	...
	public String getAddress(String ip) {
		...
		//System.out.println("IP地址查询"+timer.getStr());
		return address;
	}

//	public static void main(String[] args) {
//		IPSeeker p = IPSeeker.getInstance();
//		System.out.println(p.getAddress("0.0.0.1"));
//	}
}