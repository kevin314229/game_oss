 ...
 * 
 */
public class ZHOssActivityDetail implements Serializable {
    ...
    public ZHOssActivityDetail() {
    }

    public ZHOssActivityDetail(Integer id, Long activityId, String value,
    ...
    public List<Map<String, Object>> getItemList() {
 	...
 	if(item!=null&&!"".equals(item)){
 		...
 		paraMap.put("itemId", Integer.parseInt(temp[0]));
