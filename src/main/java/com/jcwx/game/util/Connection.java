...
public class Connection {
    ...
    static class ConnectionUtilInstance {
	static Connection connection = new Connection();
    }

    public static Connection getInstance() {
	return ConnectionUtilInstance.connection;
    }
    ...
    public String getContentTypeString(OssServer ossServer)
     ...
     * @throws Exception
     */
    public String getContentTypeString(URL url) throws Exception {
	HttpURLConnection urlConnection = (HttpURLConnection) url
		.openConnection();
	urlConnection.addRequestProperty(CONTENT_TYPE, CONTENT_JSON);
     ...
     * @throws Exception
     */
    public Map<String, Object> interfaceSendMsg(Integer serverId,
     ...
     * @return
     */
    public boolean isConnection(OssServer ossServer) {
	try {
    ...
    public boolean isConnection(URL url) {
	try {
     ...
     * @throws Exception
     */
    public Map<String, Object> sendMsg(Integer serverId, String contentType,
	    Map<String, Object> paraMap) throws Exception {
    ...
    public Map<String, Object> sendMsg(OssServer ossServer, String contentType,
	    Map<String, Object> paraMap) throws Exception {
	...
	try {
	    ...
	    throw ActionValidateException.newActionValidateException(e);
     ...
     * @throws Exception
     */
    public Map<String, Object> sendMsg(String contentType,
	    Map<String, Object> paraMap) throws Exception {
    ...
    public void setContentTypesendMsg(String address, String key) {
	try {
    ...
    public Map<String, Object> sendMessageX(Map<String, Object> object)
            throws Exception {
