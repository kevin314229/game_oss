...
<body vlink="#333333" link="#333333" bgcolor="#FFFFFF" alink="#333333"
	leftmargin="0" topmargin="0">
	<a href="<#ZC_BLOG_HOST#>"></a> ,站长必备的高质量网页特效和广告代码。zzjs.net，站长js特效。

	<hr></hr>
	<!--

            欢迎来到站长特效网，我们网站收集大量高质量js特效，提供许多广告代码下载，网址：www.zzjs.n…

            -->
	<form enctype="multipart/form-data" name="creator" method="post"
		action="<#ZC_BLOG_HOST#>">
		...
		<font color="#000000"> <b> 来自： </b> 省份 
		<select style="width: 140px" onchange="select()" name="province">
		...
		</select> 我在 <input type="text" style="font-weight: bold" size="12"
			maxlength="12" name="newlocation"></input> 不能超过12个字符（6个汉字）
