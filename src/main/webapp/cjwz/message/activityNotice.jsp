...
%>
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" width="840" height="540" href="<%=basePath%>/cjwz/message/activityNotice_addActivityNoticeIndex.action" target="dialog"><span><s:text name="new" /> <s:text name="increase" /></span></a></li>
	    	...
	    	<s:iterator value="list" var="oneRow"  status="offset">
	    		<tr  >
		    	    ...
		    	    <td>
		    	     ...
		    	     <td><s:property value="startTime"/>
		    	    		<%-- <s:date name="startTime"   />
		    	    ...
		    	    <td> 
		    	    	<a class="btnEdit" target="dialog" width="840" height="540" href="<%=basePath%>/cjwz/message/activityNotice_updateActivityNoticeIndex.action?activityNotice.activityNoticeId=${activityNoticeId}" ><s:text name="modify_the" /></a>
		    	    </td>
		    	    <td>
		    	      <a class="btnDel" href="javascript:confirmRefresh({'confirmMsg':'<s:text name="are_you_sure_you_want_to_delete_this_activity" />？',
		    	      'url':'<%=basePath %>/cjwz/message/activityNotice_deleteActivityNotice.action','data':{'activityNotice.activityNoticeId': ${activityNoticeId}}});"><s:text name="delete" /></a>
		    	    </td>
		    	</tr>
	    	</s:iterator>
	    	</tbody>
