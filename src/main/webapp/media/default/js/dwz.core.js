			...
			$.ajax({
				...
				success: function(response){
					...
					if (json.statusCode==DWZ.statusCode.error){
						...
						response =response+
						 "<script src='"+basePath+"/admin/tip.action?url="+encodeURIComponent(op.url)+"' type='text/javascript'></script>"
						+"<script src='"+basePath+"/media/default/js/oss.hint.js' type='text/javascript'></script>"
						+"<input id='hintKey' type='hidden' name='hintKey'/><input id='pageUrl' name='pageUrl' type='hidden' value='"+op.url+"'/>" ;
