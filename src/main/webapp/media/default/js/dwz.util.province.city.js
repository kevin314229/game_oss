...
selectProvince:function(province,city) {
	var where = jQuery.provinceCity.where;
	with (province[0]) {
 ...
 initProvince:function( province,city) {
	 jQuery.provinceCity.initWhere();
	 var where = jQuery.provinceCity.where;
	with (province[0]) {
		length = where.length;
	...
	province.change(function(){
		jQuery.provinceCity.selectProvince(province,city);
	});
}
