...
function _getPagerForm($parent, args) {
	...
	if (form) {
		if (args["pageNum"]&&form[DWZ.pageInfo.pageNum]) form[DWZ.pageInfo.pageNum].value = args["pageNum"];
		if (args["numPerPage"]&&form[DWZ.pageInfo.numPerPage]) form[DWZ.pageInfo.numPerPage].value = args["numPerPage"];
		
		if (args["page.pageNum"]&&form[DWZ.pageInfo.pageNumNew]) form[DWZ.pageInfo.pageNumNew].value = args["page.pageNum"];
		if (args["page.numPerPage"]&&form[DWZ.pageInfo.numPerPageNew]) form[DWZ.pageInfo.numPerPageNew].value = args["page.numPerPage"];
		...
		if (args["page.orderFlag"] && form[DWZ.pageInfo.page.orderFlag]) form[DWZ.pageInfo.page.orderFlag].value = args["orderField"].toUpperCase();
	}
