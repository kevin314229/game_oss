...
<html>
  ...
  <body>
	...
	<div id="divLeft">
		新增怪物：
		<s:form action="addBaseMonster" namespace="/admin/skill" method="post" theme="simple">
		...
		<td>怪物类型：</td>
		<td><s:select list="#{'1':'人形','2':'猛兽','3':'机械'}" name="monsterType" listKey="key" listValue="value"/>
		</td>
		</tr>
		<tr><td> 技能ID：</td>
