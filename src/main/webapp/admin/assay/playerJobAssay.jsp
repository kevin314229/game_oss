...
<div class="pageHeader">
		<s:form action="/admin/assay/playerJobAssay.action" method="post" theme="simple" cssClass="pageForm required-validate" onsubmit="return $(this).valid()&&navTabSearch(this)">
			   <div class="searchBar">
			    ...
			    <table class="list" width="100%">
			    	...
			    	<tbody>
				    	<s:iterator value="totalJobList" var="oneRow"  status="offset">
				    		<tr  >
					    	    <td>
					    	     <s:if test="#oneRow.jobs==1"><span class="color-gr"><s:text name="a_warrior" /></span></s:if>
					    	     <s:elseif test="#oneRow.jobs==2"><span class="color-gr"><s:text name="the_mage" /></span>
								 </s:elseif>
								 <s:else ><span class="color-gr"><s:text name="the_archer" /></span></s:else>
								 </td>
					    	     <td>
	    	  ...
	    	  <div>
			      <table class="list" width="100%" >
			    	...
			    	<tr>
			    	    ...
			    	    <th><s:text name="a_warrior" /></th>
			    	    <th><s:text name="the_mage" /></th>
			    	    <th><s:text name="the_archer" /></th>
			    	</tr>
			    	</thead>
			    	<tbody>
