...
<div class="pageHeader">
		<s:form action="zMetallurgyDay_index" method="post" id="queryForm" theme="simple" cssClass="pageForm required-validate" onsubmit="return $(this).valid()&&navTabSearch(this)">
		<div class="searchBar">
		...
		<table class="list" width="100%" layoutH="50">
			<thead>
				...
				<tr class="even" >
					...
					<td><s:text name="practice_the_number_of_gold" /></td>
					<td><s:text name="gold_number" /></td>
					<td><s:text name="pay_gold_number" /></td>
					<td><s:text name="monster_crystal_total_consumption" /></td>
				</tr>
			</thead>
			<s:iterator value="ossZMetallurgyDayList" status="offsets" var="zMetallurgyDay">
				<tr>
					<td><s:property value="dateTime"/> </td>
					<td><s:property value="metallurgyNub" /> </td>
					<td><s:property value="metallurgyCount" /> </td>
					<td><s:property value="goldNub" /> </td>
