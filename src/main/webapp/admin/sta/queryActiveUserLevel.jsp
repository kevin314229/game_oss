...
<form id="pagerForm" method="post" action="#rel#">
	<input type="hidden" name="currPageNO" value="${currPageNO}" /> <input
		...
		type="hidden" name="gameId" id="activeUserLevel_gameId"
		value="${gameId}" />

</form>
<div class="pageHeader">
	<s:form action="queryActiveUser_Level" rel="pagerForm"
 ...
 --%>
				...
				<s:select list="OssServersPt" label="" listKey="serverId"
					...
					headerValue="%{getText('all_platforms')}" id="activeUserLevel_ptId"
					onchange="initPtIdParam('activeUserLevel_gameId',this.value,'activeUserLevel_areaId');"></s:select>
				...
				<s:select list="serverMap" label="" listKey="key" listValue="value"
					cssStyle="width:150px" name="selectArray" id="activeUserLevel_areaId"
	...
	<table class="list" width="100%" layoutH="130">
		<thead>
			...
			<!-- 	<th align="center" width="20"><s:text name="game_project" /></th> -->
				...
				var itdsrc=document.getElementById("src");
...
<%-- 					<td align="center"><s:property
		    	   ...
		    	   var tdSrc = document.getElementById("id<%=num%>");
		    		...
		    		for(var i=0;i<=end-begin;i++){
		    			...
		    			if('${lengthofSelectArray}'==1&&'${firstElementOfSelectArray}'!=-1)
		    			{
		    				...
		    				a.href="<%=basePath%>/admin/queryLostUser/queryLostUser_LevelDetail.action?queryType=2&gameId=${gameId}&areaId=${firstElementOfSelectArray}&playerLevel="
										+ level
