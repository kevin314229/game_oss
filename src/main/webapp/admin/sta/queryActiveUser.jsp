...
<form id="pagerForm" method="post" action="#rel#">
	<input type="hidden" name="currPageNO" value="${currPageNO}" /> <input
		...
		type="hidden" name="gameId" id="activerUser_gameId" value="${gameId}" />
		
</form>

<div class="pageHeader">
	<s:form action="queryActiveUser_index" rel="pagerForm"
...
<%-- 					<td><s:text name="project" />：<s:select list="#session.ADMIN_SYSTEM_USER_NAME.projectList" label=""
				...
				id="activerUser_gameId"  onchange="changePtIdOption(this.value,'activerUser_ptId','activerUser_areaId');"></s:select>
					</td> --%>
				...
				id="activerUser_ptId"  onchange="initPtIdParam('activerUser_gameId',this.value,'activerUser_areaId');">
				</s:select> 
					

					
					<s:text name="regional" />：
					<s:select list="serverMap" label="" listKey="key" listValue="value" cssStyle="width:150px" name="selectArray" id="activerUser_areaId"
...
<div class="pageContent" layoutH="150" selector="h1">
		<table class="list" width="100%" id="activeuser_tb">
			<thead>
				<tr>
...
<%-- 						<td align="center">
						...
						<td align="left"><s:property value="#oneRow.day3" />
							&nbsp;&nbsp;<span class="color-r">[<fmt:formatNumber
