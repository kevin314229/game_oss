...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a width="950" height="470" class="add" href="<%=basePath%>/admin/message/modifyActivity_addModifyActivityIndex.action" target="dialog"><span><s:text name="new" /> <s:text name="increase" /></span></a></li>
		...
		<thead>
	    	...
	    	<s:iterator value="ossActivities" var="oneRow"  status="offset">
	    		<tr >
		    	    ...
		    	    <td>
		    	     <a width="930" height="600" href="<%=basePath%>/admin/message/modifyActivity_queryPlayerActivityList.action?id=${oneRow.id}" style="color:green" class="btnEdit" target="dialog">
					    	      <span>	<s:property value="#oneRow.playerBaseTimes"/></span>
					</a>
		    	    ...
		    	    <td> 
		    	    		 <a width="930" height="600" href="<%=basePath%>/admin/message/modifyActivity_updateModifyActivityIndex.action?id=${oneRow.id}" style="color:green" class="btnEdit" target="dialog">
