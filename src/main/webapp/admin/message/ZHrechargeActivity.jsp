...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a width="950" height="670" class="add" href="<%=basePath%>/zhxy/message/ZHrechargeActivity_toAdd.action" target="dialog"><span><s:text name="new" /> <s:text name="increase" /></span></a></li>
			<li class="line">line</li>
			
			<li><a class="icon" href="javascript:confirmRefresh({'url':'<%=basePath %>/zhxy/message/ZHrechargeActivity_reflash.action'})"><span><s:text name="refresh_the_activity" /></span></a></li>
			<li
			<s:if test="#session.ADMIN_SYSTEM_USER_NAME.currentOssServer.projectId==2"> style="display:none"</s:if>
			><a class="icon" width="770" height="360"    href="javascript:queryServerList6(this);"><span><s:text name="synchronous" /></span></a></li>
		</ul>
	</div>
		...
		<thead>
	    	...
	    	<s:iterator value="ossRechargeActivityList" var="oneRow"  status="offset">
	    		<tr >
		    	    ...
		    	    <td> 
		    	    	<a width="950" height="670" href="<%=basePath%>/zhxy/message/ZHrechargeActivity_toUpdate.action?ossRechargeActivity.recharegeActivityId=${oneRow.recharegeActivityId}" style="color:green" class="btnEdit" target="dialog">
					    	   <span><s:text name="modify_the" /></span>
					    </a>
					 </td>
		    	    <td> 
		    	     <a href="javascript:confirmRefresh({'confirmMsg':'<s:text name="are_you_sure_you_want_to_delete_this_activity" />？','url':'<%=basePath %>/zhxy/message/ZHrechargeActivity_delete.action','data':{'ossRechargeActivity.recharegeActivityId':${oneRow.recharegeActivityId}}});" style="color:green" class="btnDel" >
