...
%>
	...
	<s:include value="/admin/template/scriptMessage.jsp"/>
  	<div class="pageContent">
	     <s:form action="modifyActivity_addModifyActivity" namespace="/admin/message" method="post" theme="simple" onsubmit="return send(this)&&$(this).valid()&&navTabSearch(this);" >
