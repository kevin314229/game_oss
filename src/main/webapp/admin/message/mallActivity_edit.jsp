...
%>
		...
		function onchangeItmeId(obj){
   		...
   		function checkForm(o) {
			if($("#maxNubDay").val() == 0||$("#maxNubPlayer").val()==0){
				alertMsg.info("<s:text name="maximum_number_of_purchase" />，<s:text name="can't_fill_in" /> 0 "); return false;
			}
			return true;
		}
	...
	<s:include value="/admin/template/scriptMessage.jsp"/>
		<div class="pageContent">
	     <s:form action="mallActivity_update" namespace="/admin/message" method="post" theme="simple" 
	     cssClass="pageForm required-validate" onsubmit="return checkForm(this)&&$(this).valid()&&navTabSearch(this)" >
	     	<div class="pageFormContent nowrap" layoutH="60">
		  	 <input type="hidden" name="ossMallActivity.mallActivityId" value="${ossMallActivity.mallActivityId}">
		    	<dl>
		    	    ...
		    	    <dd>
		    	    	<select  onchange="onchangeItmeId(this)">
		    	    		...
		    	    		<s:iterator value="mallActivityList" var="oneRow"  status="offset">
		    	    		 	<option value="${itemId}-${initPrice}-${rebatePrice}"><s:property value="mallName"/></option>
		    	    		</s:iterator>
		    	    	</select>
			...
			dateFmt="yyyy-MM-dd HH:mm:ss" readonly="true" cssClass="required date"  >
		    	...
		    	<dl>
		    	    ...
		    	    <dd>
		    	    	<s:select name = "ossMallActivity.state" headerKey="0" 
		    	    	list="#{ '0':getText('there_is_no'),'1':getText('new'),'2':getText('hot')}" />
		    	    </dd>
		    	</dl>
		    	<dl>
		    	    ...
		    	    <dd>
						...
						readonly="true"  dateFmt="yyyy-MM-dd HH:mm:ss" cssClass="required date">
							<s:param name="value"><s:date name="ossMallActivity.endTime" format="yyyy-MM-dd HH:mm:ss" /></s:param>
						</s:textfield>  
		    	    </dd>
		    	</dl>
		    	<dl>
		    	    ...
		    	    <dd>
		    	    	<s:select name = "ossMallActivity.vipGrade" headerKey="0" 
		    	    	list="#{ '0':getText('there_is_no'),'1':'VIP1','2':'VIP2','3':'VIP3','4':'VIP4','5':'VIP5','6':'VIP6','7':'VIP7','8':'VIP8','9':'VIP9','10':'VIP10','11':'VIP11'}" />
		    	    </dd>
		    	...
		    	<dl style="display: none">
		    	    ...
		    	    <dd>
		    	    	<s:textfield  id="costPrice" name="ossMallActivity.costPrice" ></s:textfield>
		    	    </dd>
		    	</dl>
		    	...
		    	<dl>
		    	    ...
		    	    <dd>
		    	    	<s:textarea id="describe" cols="40" rows="4"  name="ossMallActivity.describe" maxlength="12" placeholder="%{getText('description_up')+'12'+getText('words')}">
		    	    	</s:textarea>
		    	    </dd>
