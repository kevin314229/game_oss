...
%>
	...
	<s:include value="/admin/template/scriptMessage.jsp"/>
  	...
  	<div class="pageContent">
	     <s:form action="ZHrechargeActivity_doAdd" namespace="/zhxy/message" method="post" theme="simple"
		 	   ...
		 	   <div class="pageFormContent nowrap"  layoutH="60">
			        <dl>
			    	    ...
			    	    <dd>
			    	    	...
			    	    	list="#{'1':'<s:text name="once_a_day" />',
			    	    	'2':'<s:text name="activity_cycle" />'}"/>  
			    	    </dd>
			    	</dl>
				...
				dateFmt="yyyy-MM-dd HH:mm:ss" cssClass="required date" readonly="true" /> 
			    	...
			    	<div class="panel">
					    	...
					    	<div>
						    	...
						    	<thead>
						    	<tr >
							    	<th width="70" type="enum" enumUrl="<%=basePath%>/zhxy/message/ZHmodifyActivity_select.action" size="12" name="value#index#" >
