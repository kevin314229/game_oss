...
<s:include value="/admin/template/scriptMessage.jsp"/>
  <div class="pageContent"  >
	     ...
	     <s:form action="activityNotice_addActivityNotice" namespace="/admin/message" method="post" theme="simple" cssClass="pageForm required-validate" onsubmit="return $(this).valid()&&navTabSearch(this)" >
	     	<div class="pageFormContent nowrap" layoutH="60">
		    	...
		    	<dl>
		    	    ...
		    	    <dd>
		    	    	<s:textfield id="startTime"  name="ossActivityNotice.startTime"  dateFmt="yyyy-MM-dd HH:mm:00" cssClass="required date">
		    	    	</s:textfield>
		    	    </dd>
		    	</dl>
		    	<dl>
		    	    ...
		    	    <dd>
		    	    	<s:textfield id="endTime" dateFmt="yyyy-MM-dd HH:mm:59"   name="ossActivityNotice.endTime" cssClass="required date" >
		    	    	</s:textfield>
		    	    </dd>
		    	</dl>
		    </div>
