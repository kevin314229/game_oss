...
<s:include value="/admin/template/scriptMessage.jsp"/>
  	...
  	<div class="pageContent">
	   <s:form action="modifyActivity_winphone_edit" namespace="/admin/message" method="post" theme="simple"  
	     cssClass="pageForm required-validate" onsubmit="return $(this).valid()&&navTabSearch(this)">
			...
			cssClass="required date" readonly="true"/> 
		    	...
		    	<dl>
			    	    <dt>(winphone)指引页面：</dt>
			    	    <dd>
			    	    	<s:select name="ossActivity.winphoneType" cssClass="required" list="#{ 
			    	...
			    	<dl>
			    	    <dt>(winphone)说明：</dt>
			    	    <dd>
			    	    	<s:textarea name="ossActivity.winphoneContent" cssClass="required" /> 
