...
<s:include value="/admin/template/scriptMessage.jsp"/>
  	<div class="pageContent">
	    <s:form action="ossOperation_updateOssOperation" namespace="/admin/base" method="post" theme="simple"
	    cssClass="pageForm required-validate" onsubmit="return $(this).valid()&&dialogSearch(this);">
		    <s:textfield name="ossOperation.id"  cssStyle="display:none"/>
