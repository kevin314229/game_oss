...
<div class="pageHeader">
	<s:form action="queryMoneyConsume_Total" rel="pagerForm" method="post"
		...
		<tbody>
			<s:iterator value="operationClassList" var="oneRow" status="offset">
				<tr>
					...
					<td><s:property
							value="@com.jcwx.game.common.constants.OperationLogConstant@maptype[#oneRow.operation]" />
						<%-- <s:property value="@com.jcwx.game.common.constants.OperationLogConstant@getTypeLabel(#oneRow.operation)"/> --%>
					</td>
					<td><s:property value="#oneRow.remark" /></td>
