...
<div class="pageHeader">
	<s:form rel="pagerForm" action="queryPay" method="post" theme="simple" namespace="/admin/pay" cssClass="pageForm required-validate" onsubmit="return $(this).valid()&&navTabSearch(this)">
		   <div class="searchBar">
