...
<div class="pageHead">
	<s:form action="ptUser_register" method="post" theme="simple" id="queryRecoedForm" cssClass="pageForm required-validate" onsubmit="return $(this).valid()&&navTabSearch(this)">
		<div class="searchBar">	
