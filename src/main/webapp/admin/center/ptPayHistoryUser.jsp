...
<div class="pageHead">
	<s:form action="ptPayHistory_user" method="post" theme="simple" id="queryRecoedForm" cssClass="pageForm required-validate" onsubmit="return $(this).valid()&&navTabSearch(this)">
		<div class="searchBar">	
