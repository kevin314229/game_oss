...
%>
	...
	$(function() {
		 ...
		 var width=$('#keepContainer')[0].scrollWidth;
...
<div class="pageHeader">
	<s:form action="/zhxy/assay/queryKeep.action" namespace="/zhxy/assay" method="post" theme="simple" cssClass="pageForm required-validate" onsubmit="return $(this).valid()&&navTabSearch(this)">
		   <div class="searchBar">
		    ...
		    <table class="list" width="100%" id="queryKeep_tb1">
		    	...
		    	<s:iterator value="keepList" var="oneRow"  status="offset">
		    		<tr >
						...
						<td>
						<s:if test="#oneRow.day1==0">
								<s:property value="#oneRow.day2"/> &nbsp;&nbsp;<span class="color-gr">[0%]</span>
						</s:if>
						<s:else>
						...
						<td>
						<s:if test="#oneRow.day1==0">
								<s:property value="#oneRow.day3"/> &nbsp;&nbsp;<span class="color-gr">[0%]</span>
						</s:if>
						<s:else>
						...
						<td>
						<s:if test="#oneRow.day1==0">
								<s:property value="#oneRow.day4"/> &nbsp;&nbsp;<span class="color-gr">[0%]</span>
						</s:if>
						<s:else>
						...
						<td>
						<s:if test="#oneRow.day1==0">
								<s:property value="#oneRow.day5"/> &nbsp;&nbsp;<span class="color-gr">[0%]</span>
						</s:if>
						<s:else>
						...
						<td>
						<s:if test="#oneRow.day1==0">
								<s:property value="#oneRow.day6"/> &nbsp;&nbsp;<span class="color-gr">[0%]</span>
						</s:if>
						<s:else>
						...
						<td>
						<s:if test="#oneRow.day1==0">
								<s:property value="#oneRow.day7"/> &nbsp;&nbsp;<span class="color-gr">[0%]</span>
						</s:if>
						<s:else>
						...
						<td>
						<s:if test="#oneRow.day1==0">
								<s:property value="#oneRow.day8"/> &nbsp;&nbsp;<span class="color-gr">[0%]</span>
						</s:if>
						<s:else>
							<s:property value="#oneRow.day8"/> &nbsp;&nbsp;<span class="color-gr">[<fmt:formatNumber value="${oneRow.day8/oneRow.day1 *100}" pattern="#.##" minFractionDigits="0" />%]</span>
						</s:else>
						</td>
						<td>
						<s:if test="#oneRow.day1==0">
								<s:property value="#oneRow.day14"/> &nbsp;&nbsp;<span class="color-gr">[0%]</span>
						</s:if>
						<s:else>
						...
						<td>
						<s:if test="#oneRow.day1==0">
								<s:property value="#oneRow.day30"/> &nbsp;&nbsp;<span class="color-gr">[0%]</span>
						</s:if>
						<s:else>
