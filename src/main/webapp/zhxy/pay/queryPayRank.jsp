...
<div class="pageHeader">
	<s:form action="zhqueryPayRank" rel="pagerForm" method="post" id="queryForm" theme="simple" cssClass="pageForm required-validate" onsubmit="return $(this).valid()&&navTabSearch(this)">
		<div class="searchBar">
	    ...
	    <table  class="list" width="100%" layoutH="65">
	    	...
	    	<s:iterator value="payHistoryRankList" var="onePay" status="offset">
	    		<tr>
		    	    ...
		    	    <td >
						<a target="dialog" width="900" height="800" href="<%=basePath%>/zhxy/player/zhplayerInfo_viewPlayInfo.action?playerId=${onePay.playerId }" style="color:#60A70C;text-decoration: none"><s:property value="#onePay.loginName"/></a>
		    	    </td>
		    	    <!-- 
		    	    <td>
