...
%>
	...
	<script type="text/javascript" language="javascript">
		...
		function queryServerList3(obj){
			...
			$.pdialog.open("<%=basePath%>/admin/message/zhfunctionAdjust_server.action?syncType=3&types="+sign, "3", "<s:text name="synchronous" />",  {width:760,height:720});
		}
	</script>
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" width="840" height="600" href="<%=basePath%>/zhxy/message/activityNotice_addActivityNoticeIndex.action" target="dialog"><span><s:text name="new" /> <s:text name="increase" /></span></a></li>
			<li class="line">line</li>
			<li><a class="icon" href="javascript:confirmRefresh({'url':'<%=basePath%>/zhxy/message/activityNotice_reflash.action'})" ><span><s:text name="the_refresh" /></span></a></li>
	    		...
	    		<tr  >
		    	    ...
		    	    <td>
		    	     ...
		    	     <td>
		    	        ...
		    	        <s:if test="#oneRow.noticeType==0">
		    	    	公告栏
		    	    	</s:if>
		    	    	<s:elseif test="#oneRow.noticeType==1">
		    	    	更新栏
		    	    	</s:elseif>
		    	    </td>
		    	     <td>
		    	    ...
		    	    <td> 
		    	    	<a class="btnEdit" target="dialog" width="840" height="600" href="<%=basePath%>/zhxy/message/activityNotice_updateActivityNoticeIndex.action?ossActivityNotice.activityNoticeId=${activityNoticeId}" ><s:text name="modify_the" /></a>
		    	    </td>
		    	    <td>
		    	      <a class="btnDel" href="javascript:confirmRefresh({'confirmMsg':'<s:text name="are_you_sure_you_want_to_delete_this_activity" />？',
		    	      'url':'<%=basePath %>/zhxy/message/activityNotice_deleteActivityNotice.action','data':{'ossActivityNotice.activityNoticeId': ${activityNoticeId}}});"><s:text name="delete" /></a>
		    	    </td>
		    	</tr>
	    	</s:iterator>
	    	</tbody>
