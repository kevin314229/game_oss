...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a width="950" height="490" class="add" href="<%=basePath%>/zhxy/message/modifyActivity_addModifyActivityIndex.action" target="dialog"><span><s:text name="new" /> <s:text name="increase" /></span></a></li>
	    	...
	    	<s:iterator value="ossActivities" var="oneRow"  status="offset">
	    		<tr >
		    	   ...
		    	   <%--   <td>
		    	    ...
		    	    <td> 
		    	    		 <a width="930" height="600" href="<%=basePath%>/zhxy/message/modifyActivity_updateModifyActivityIndex.action?id=${oneRow.id}" style="color:green" class="btnEdit" target="dialog">
