...
<script type="text/javascript">
 ...
 function confirmSubmit(){
	   ...
	   if(syncType=="1"){//<s:text name="synchronization_point" />
		   ...
		   url="<%=basePath%>/zhxy/message/activityNotice_syn.action";
	   ...
	   }else  if(syncType=="7"){ //<s:text name="synchronization_fighting_spirit_mall" />
		   url="<%=basePath%>/admin/message/mallNew_syn.action";
		} else  if(syncType=="8"){//同步每日首充
...
<s:include value="/admin/template/scriptMessage.jsp"/>
		...
		<div class="pageContent">
	     <s:form action="zhfunctionAdjust_reflash" namespace="/admin/message" method="post" theme="simple"
