	...
	<script type="text/javascript" language="javascript">
		...
		function deleteModifyActivity(id) {
			if (confirm("<s:text name="are_you_sure_you_want_to_delete_this_activity" />？")){
				self.location ="<%=basePath %>/zhxyzc/message/modifyActivity_deleteModifyActivity.action?id="+id;
			}
		}
		...
		function reflash(){
			$.ajax({
	            ...
	            url: "<%=basePath%>/zhxyzc/message/modifyActivity_reflash.action",
	            cache: false,
	            ...
	            window.location="<%=basePath %>/zhxyzc/message/modifyActivity_index.action";
		...
		function checkItem(){
		    ...
		    $.ajax({
	            type: "post",//<s:text name="use" />post<s:text name="methods_to_access_the_background" />
	            url: "<%=basePath%>/zhxyzc/message/modifyActivity_syn.action",
	            cache: false,
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a width="950" height="490" class="add" href="<%=basePath%>/zhxyzc/message/modifyActivity_addModifyActivityIndex.action" target="dialog"><span><s:text name="new" /> <s:text name="increase" /></span></a></li>
			<li class="line">line</li>
			
			<li><a class="icon" href="javascript:confirmRefresh({'url':'<%=basePath %>/zhxyzc/message/modifyActivity_reflash.action'})"><span><s:text name="refresh_the_activity" /></span></a></li>
	    	...
	    	<s:iterator value="ossActivities" var="oneRow"  status="offset">
	    		<tr >
		    	   ...
		    	   <%--   <td>
		    	    ...
		    	    <td> 
		    	    		 <a width="930" height="600" href="<%=basePath%>/zhxyzc/message/modifyActivity_updateModifyActivityIndex.action?id=${oneRow.id}" style="color:green" class="btnEdit" target="dialog">
					    	      	<span><s:text name="modify_the" /></span>
					    	      </a>
					 </td>
		    	    <td> 
		    	     		 <a href="javascript:confirmRefresh({'confirmMsg':'<s:text name="are_you_sure_you_want_to_delete_this_activity" />？','url':'<%=basePath %>/zhxyzc/message/modifyActivity_deleteModifyActivity.action','data':{'id':'${oneRow.id}'}});" style="color:green" class="btnDel" >
