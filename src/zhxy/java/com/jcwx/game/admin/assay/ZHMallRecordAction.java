...
@ResultPath("/")
public class ZHMallRecordAction extends BaseInfoAction {
    ...
    @Action(value = "mallRecord_index", results = { @Result(name = "success", location = "../../zhxy/assay/mallRecordAssay.jsp") })
