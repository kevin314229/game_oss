...
@ResultPath("/")
public class ZHPlayerMoneyAction extends BasalAction {
    ...
    @Action(value = "zhplayermoney_equipmodify", results = { @Result(name = "success", type = "redirectAction", params = {
	    "actionName", "zhplayermoney_index", "namespace", "/zhxy/message",
     ...
     * @throws
     */
    @Action(value = "zhplayermoney_itemmodify", results = { @Result(name = "success", type = "redirectAction", params = {
	    "actionName", "zhplayermoney_index", "namespace", "/zhxy/message",
	    "actionMsg", "${actionMsg}", "loginName", "${loginName}",
	    "nickName", "${nickName}" }) })
     ...
     * @throws
     */
    @Action(value = "zhplayermoney_modify", results = { @Result(name = "success", type = "redirectAction", params = {
	    "actionName", "zhplayermoney_index", "namespace", "/zhxy/message",
	    "actionMsg", "${actionMsg}", "loginName", "${loginName}",
	    "nickName", "${nickName}" }) })
     ...
     * @throws
     */
    @Action(value = "zhplayermoney_index", results = { @Result(name = "success", location = "../../zhxy/message/playerMoney.jsp") })
     ...
     * @throws
     */
    @Action(value = "zhplayermoney_detail", results = { @Result(name = "success", location = "../../zhxy/message/playerMoney.jsp") })
     ...
     * @throws
     */
    @Action(value = "zhplayermoney_sdatamodify", results = { @Result(name = "success", type = "redirectAction", params = {
	    "actionName", "zhplayermoney_index", "namespace", "/zhxy/message",
	    "actionMsg", "${actionMsg}", "loginName", "${loginName}",
	    "nickName", "${nickName}" }) })
	...
	if (ossPlayerMoneys != null && ossPlayerMoneys.size() == 1) {
	    ...
	    //setZPlayerSdata(baseAdminContext, ossPlayerMoneys.get(0).getPlayerId());
	}
    }
   ...
   /* @SuppressWarnings("unchecked")
	...
	//ossPlayerSdataVo = PlayerSdataVo.convertSdataVoList(playerSdataList,playerId);
    }*/
}
