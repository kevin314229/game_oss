...
@ResultPath("/")
public class ZHActivityNoticeAction extends BasalAction {
    ...
    @Action(value = "activityNotice_addActivityNoticeIndex", results = { @Result(name = "success", location = "../../zhxy/message/addActivityNotice.jsp") })
    ...
    @Action(value = "activityNotice_deleteActivityNotice", results = { @Result(name = "success", type = "redirectAction", params = {
	    "actionName", "activityNotice_index", "namespace", "/zhxy/message",
	    "actionMsg", "${actionMsg}" }) })
    ...
    @Action(value = "activityNotice_index", results = { @Result(name = "success", location = "../../zhxy/message/activityNotice.jsp") })
    ...
    // 同步到其他服务器代码
    @Action(value = "activityNotice_syn", results = { @Result(name = "success", location = "../../zhxy/message/activityNotice.jsp") })
    ...
    @Action(value = "activityNotice_updateActivityNotice", results = {
	    @Result(name = "success", type = "chain", params = { "actionName",
		    "activityNotice_index", "namespace", "/zhxy/message",
		    "actionMsg", "${actionMsg}" }),
	    @Result(name = "error", location = "../../zhxy/server/addActivityNotice.jsp") })
    ...
    /** 修改游戏加载页面 */
    @SuppressWarnings("unchecked")
    @Action(value = "activityNotice_updateActivityNoticeIndex", results = { @Result(name = "success", location = "../../zhxy/message/updateActivityNotice.jsp") })
