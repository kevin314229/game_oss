...
@Namespace("/zhxy/pay")
@ResultPath("/")
public class ZHPayAssayAction extends BasalAction {
     ...
     * @throws Exception
     */
    @Action(value = "payAssay", results = { @Result(name = "success", location = "../../zhxy/pay/payAssay.jsp") })
     ...
     * @throws Exception
     */
    @Action(value = "payAssay_pt", results = { @Result(name = "success", location = "../../zhxy/pay/ptPayAssay.jsp") })
